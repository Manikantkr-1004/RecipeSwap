...
export const RecipeStep = () => {
  ...
  return (
    <DIV>
        ...
        <div>
            <img className='img-1' src="https://www.allrecipes.com/thmb/2tg4K_LB9bndxHv4tIdDjSrFAFc=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/878779-457b0ff72c9a4f438c1756ef03773e5f.jpg" alt="error" />
        </div>
    </DIV>
  )
}
